        ...
        !paymentMethods.loading ? (
            !paymentMethods.error ? (
                <div className="mt-5 flex flex-col items-center">
                    ...
                    <h1 className="mt-6">Método de pago</h1>
                    ...
                    <h1 className="mt-6">Datos del envío</h1>
                    <div className="mt-2 w-full bg-gray-50 p-4 border border-gray-300">
                    ...
                    <PrimaryButton
                        ...
                        disabled={
                            paymentMethods.value.length === 0 ? true : false
                        }
                    >
                        Realizar pedido
                    </PrimaryButton>
